...
class reestr(models.Model):
    reestrID = models.ForeignKey(reestInfo, on_delete=models.CASCADE)
...
class files(models.Model):
    reestr = models.ForeignKey(reestInfo, on_delete=models.CASCADE)
    belong_to = models.TextField()
